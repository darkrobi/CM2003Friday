...
function callApi(postcode, cuisine){
...
$.ajax({
	...
	success:function(data){
		...
		data.Restaurants.slice(1,6).forEach(function(restaurant){
			var content = "<div class='rest'>" + "<div class='rest_logo'>" + "<img src='" + restaurant.Logo["0"].StandardResolutionURL + "'>" + "</div>" + "<h2><a href='https://www.just-eat.co.uk/'>" +restaurant.Name+"</a></h2>" + "<p class='rest_p'>Cuisine Type: " + restaurant.CuisineTypes["0"].Name + "<br/> Address: " + restaurant.Postcode + ", " + restaurant.Address+ "<br/>" + "Opening: " + restaurant.OpeningTimeIso + "</p>" + 
				"</div>" + "<hr>";
